...
public class AxeAttack : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (energyBall != null && energyBall.activeInHierarchy && player != null)
        {
            direction = (player.position - energyBall.transform.position).normalized;
    ...
    private void Shoot()
    {
        ...
        if (energyBall != null)
        {
            ...
            energyBall.transform.position = myTransform.position + new Vector3(10f, 0, 0) ;
            energyBall.GetComponent<EnergyBallEnemyScript>().SetDirection(direction);
        }
